...
<form action="includes/dbget.php" method="POST">
  <div class="card-header"style="font-size:40px">Enter Joke_ID:</div>
<div class="card-body">
    <h5 class="card-title"style="font-size:50px"><input type="text" name="jok" placeholder="joke_id"></h5>
